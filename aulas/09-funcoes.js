/*
   ...
   função -> Uma função em JavaScript é um bloco de código utilizavel que executa uma tarefa quando é chamado
*/
...
/* Criar função que escreve bom dia */
function bomDia() {
  console.log("Olá, muito bom dia pra você!");
}
